...
// Dados fake só pra inspecionar o layout no navegador. /preview serve o HTML
// EXATO que vira PDF — sem React por volta (evita aninhar <html> e quebrar hidratação).
...
export async function GET() {
  return new Response(renderRelatorioHTML(fake), {
